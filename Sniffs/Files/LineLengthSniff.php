 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class A24StudioCS_Sniffs_Files_LineLengthSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function checkLineLength(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $lineContent)
    {
        ...
        foreach ($arrExcludedTags as $sSingleTag) {
            if (preg_match('| ' . $sSingleTag . ' |', $lineContent) !== 0) {
                return;
            }
        }
